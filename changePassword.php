...
<body>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 profile-left d-flex flex-column p-5">
                    ...
                    <div id="ajustes-options" class="ajustes-options">
                        ...
                        <div class="my-2">
                            <span><a class="active" href="changePassword.php?id=<?= $memberID ?>" target="_self" title="Enlace a la página de cambio de contraseña">Cambia la contraseña</a></span>
                        </div>
                        <div class="my-2">
                        ...
                        <div class="col-12 p-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cambia la contraseña</li>
                                </ol>
                            </nav>
                            <h5 class="text-uppercase text-black">Cambia la contraseña</h5>
                        </div>
                    </div> <!-- /.row -->

                    <!-- Fila del contenido superior de la sección -->
                    <div class="row profile-content d-flex justify-content-start gap-3 p-3">
                        <div class="col-12 col-lg-5 bg-white p-3">
                            <form action="controlador/procesarPassChange.php?id=<?= $memberID ?>" method="POST">
                                <div class="mb-3">
                                    <label for="previousPass" class="form-label">Introduce la contraseña anterior</label>
                                    <input type="password" class="form-control" id="previousPass" name= "previousPass" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="newPass" class="form-label">Introduce tu nueva contraseña</label>
                                    <input type="password" class="form-control" id="newPass" name= "newPass" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="repeatNewPass" class="form-label">Vuelve a introducir tu nueva contraseña</label>
                                    <input type="password" class="form-control" id="repeatNewPass" name= "repeatNewPass" aria-describedby="emailHelp">
                                </div>
    ...
    <script>  
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Verificar si la variable "success" tiene el valor "false"
            if (urlParams.get("success") === "false") {
                // Mostrar el SweetAlert al cargar la página
                Swal.fire({
                    title: 'Oops!',
                    text: 'Las contraseñas introducidas no coinciden. Por favor, vuelve a intentarlo.',
                    icon: 'error',
