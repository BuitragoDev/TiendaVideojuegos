...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if(isset($_SESSION['usuario'])){
        ...
        if ($result === false) {
            ...
            if(isset($_GET['anadir'])) { // Si venimos de añadir al carrito de la página de artículo.
                
                $anadir = $_GET['anadir'];
                header("Location: ../articulo.php?id=" . $anadir);
                exit;

            } elseif(isset($_GET['portada'])) { // Si venimos de añadir al carrito de un producto del carrusel del index.
                ...
                header("Location: ../checkout/cart.php"); // Otros casos.
                exit;
