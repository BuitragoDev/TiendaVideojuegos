...
<body>
  ...
  <main class="container-fluid p-0">
    ...
    <div class="container digital-products pt-3">
        ...
        <!-- Sección 1 de la página PRODUCTOS DIGITALES (título y buscador) -->
        <div class="row">
          <div class="col-12 col-lg-8">
            <h1 class="text-white">Productos digitales</h1>
          </div>
    ...
    <div class="container">
      ...
      <!-- Sección 2 de la página PRODUCTOS DIGITALES (4 imagenes) -->
      <div class="row d-flex flex-column flex-lg-row justify-content-between align-items-center gap-2 gap-lg-2 my-5 ticket-digital">

        <div class="col-12 col-lg-3 d-flex flex-column justify-content-center align-items-center">
          <a href="#" target="_self" title=""><i class="fa-solid fa-triangle-exclamation"></i></a>
          <a href="#" target="_self" title="" class="text-white fs-4 mt-3">Problemas de activación</a>
        </div>
        <div class="col-12 col-lg-3 d-flex flex-column justify-content-center align-items-center">
          <a href="#" target="_self" title=""><i class="fa-solid fa-cash-register"></i></a>
          <a href="#" target="_self" title="" class="text-white fs-4 mt-3">Pago</a>
        </div>
        <div class="col-12 col-lg-3 d-flex flex-column justify-content-center align-items-center">
          <a href="#" target="_self" title=""><i class="fa-solid fa-truck"></i></a>
          <a href="#" target="_self" title="" class="text-white fs-4 mt-3">Entrega de productos</a>
        </div>
        <div class="col-12 col-lg-3 d-flex flex-column justify-content-center align-items-center">
          <a href="#" target="_self" title=""><i class="fa-regular fa-lightbulb"></i></a>
          <a href="#" target="_self" title="" class="text-white fs-4 mt-3">Guías de activación</a>
        </div>
