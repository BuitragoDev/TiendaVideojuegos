                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <div id="micuenta-options" class="micuenta-options">
                                ...
                                <div id="historial-inicio-sesion" class="my-2">
                                    <span><a class="active" href="#" >Historial inicio de sesión</a></span>
                                </div>
                            </div>
                        ...
                        <div class="col-12 p-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Historial inicio de sesión</li>
                                </ol>
                            </nav>
                            <h5 class="text-uppercase text-black">Historial inicio de sesión</h5>
                        </div>
                    </div> <!-- /.row -->

                    <!-- Fila del contenido superior de la sección -->
                    <div class="row profile-content d-flex justify-content-start gap-3 p-3">
                        <div class="col-12 col-lg-11 bg-white p-0">
                            <table class="table table-hover table-striped table-responsive">
                                
                                <thead class="table-primary">
                                    <tr class="d-flex flex-column flex-lg-row">
                                        <th class="col-12 col-lg-2" scope="col">Fecha</th>
                                        <th class="col-12 col-lg-2" scope="col">IP</th>
                                        <th class="col-12 col-lg-2" scope="col">País</th>
                                        <th class="col-12 col-lg-6" scope="col">Nombre Dispositivo</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM sessionInit WHERE memberID = $id";
                                        $resultado = $mysqli->query($sql); 
                                        while ($fila = $resultado->fetch_object()) {
                                    ?>
                                    <tr class="d-flex flex-column flex-lg-row">
                                        <td class="col-12 col-lg-2"><?= $fila->startingDate ?></td>
                                        <td class="col-12 col-lg-2"><?= $fila->ip ?></td>
                                        <td class="col-12 col-lg-2"><?= $fila->country ?></td>
                                        <td class="col-12 col-lg-6"><?= $fila->device ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
