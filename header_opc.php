    ...
    <div class="container">
        ...
        <div class="row topRow px-1">
            ...
            <div class="col-2 col-lg-4 d-flex justify-content-start align-items-center gap-3 logo">
                ...
                <a href="../index.php" target="_self"><img class="mb-1" src="/proyecto2/assets/img/logo.webp" alt="Imagen del Logo"></a><a
                    ...
                    <nav class="navbar navbar-expand-lg text-white">
                        ...
                        <div class="collapse navbar-collapse d-lg-flex gap-5" id="navbarSupportedContent">
                            ...
                            <form id="buscador" action="javascript:void(0);" method="POST" class="d-flex d-lg-none" role="search">
                                <input class="form-control me-2" type="search" id="cajaBuscador" name="buscar" placeholder="Buscar" aria-label="Search" onkeypress="checkSubmitSupport(event)">
                                <button class="btn btn-outline-dark" type="submit" onclick="submitFormSupport()">Buscar</button>
                            </form>
