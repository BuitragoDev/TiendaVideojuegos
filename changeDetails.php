                ...
                <div class="col-12 col-lg-9 profile-right">
                    ...
                    <div class="row">
                        <div class="col-12 p-3">
                            ...
                            <h5 class="text-uppercase text-black">Datos personales</h5>
                        </div>
                    </div> <!-- /.row -->
                    ...
                    <div class="row profile-content d-flex justify-content-start gap-3 p-3">
                        <div id="userView" class="col-12 col-lg-6 bg-white p-3">
                            <div class="row d-flex justify-content-between">
                                <div class="col-12">
                                    <form class="row g-3" action="controlador/procesarUserDetails.php?id=<?= $memberID ?>" method="POST">
                                        <?php
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $fila->name ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputPassword4" class="form-label">Apellidos</label>
                                            <input type="text" class="form-control" id="inputPassword4" name="apellidos" value="<?= $fila->surname ?>">
                                        </div>
                                        <div class="col-12">
                                            <label for="apellidos" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="apellidos" name="correo" placeholder="Calle, piso, puerta..." value="<?= $fila->email ?>">
                                        </div>
                                        <div class="col-12">
                                            <label for="nacimiento" class="form-label">Fecha de Nacimiento</label>
                                            <input type="date" class="form-control" id="nacimiento" name="nacimiento" value="<?= $fila->birthDate ?>">
                                        </div>
                                        <div class="col-12">
                                            <label for="direccion" class="form-label">Dirección</label>
                                            <input type="text" class="form-control" id="direccion" name="direccion" placeholder="" value="<?= $fila->address ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="ciudad" class="form-label">Ciudad</label>
                                            <input type="text" class="form-control" id="ciudad" name="ciudad" value="<?= $fila->city ?>">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="pais" class="form-label">País</label>
                                            <input type="text" class="form-control" id="pais" name="pais" value="<?= $fila->country ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <label for="zip" class="form-label">CP</label>
                                            <input type="text" class="form-control" id="zip" name="zip" value="<?= $fila->zip ?>">
                                        </div>
                                        <div class="col-12">
